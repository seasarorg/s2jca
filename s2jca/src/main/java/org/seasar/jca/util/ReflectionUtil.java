...
public class ReflectionUtil {
    ...
    public static Class<?> forName(final String className) throws ClassNotFoundRuntimeException {
        return forName(className, Thread.currentThread().getContextClassLoader());
    }

    public static Class<?> forName(final String className, final ClassLoader loader)
    ...
    public static <T> T newInstance(final Class<T> clazz) throws InstantiationRuntimeException,
